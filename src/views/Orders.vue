  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          headerName: 'Наименование исследования',
          headerKey: 'b',
          style: {
            width: '200px',
            minWidth: '200px',
        ...
        {
          headerName: 'Дата поступления в лабораторию Исполнителя (Дата направления)',
          headerKey: 'd',
          style: {
            width: '170px',
            minWidth: '170px',
        ...
        {
          headerName: 'Регламентный срок выдачи результата (дата)',
          headerKey: 'e',
          style: {
            width: '200px',
            minWidth: '200px',
        ...
        {
          headerName: 'ИТОГО Стоимость с учетом скидок',
          headerKey: 'g',
          style: {
            width: '200px',
            minWidth: '200px',
