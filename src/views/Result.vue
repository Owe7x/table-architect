<template>
  <div id="app">
    ...
    <div class="block__button">
          ...
          <button class="button">Печать</button>
          <button class="button">Сохранить в Excel</button>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          headerName: 'ФИО / дата рождения пациента',
          headerKey: 'b',
          style: {
            width: '200px',
            minWidth: '200px',
        ...
        {
          headerName: 'Наименования исследования',
          headerKey: 'e',
          style: {
            width: '200px',
            minWidth: '200px',
        ...
        {
          headerName: 'Регламентый срок выдачи результаты (дата)',
          headerKey: 'f',
          style: {
            width: '200px',
            minWidth: '200px',
        ...
        {
          headerName: 'Дата фактической выдачи результата',
          headerKey: 'h',
          style: {
            width: '200px',
            minWidth: '200px',
